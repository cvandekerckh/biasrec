...
class Rating(db.Model):
    ...
    # def create_rating(self, user_id, product_id, rating):
    #     session = db.Session()
    #     existing_rating = session.query(self).filter_by(user_id=user_id, product_id=product_id).first()
        
    #     if existing_rating:
    #         existing_rating.rating = rating
    #     else:
    #         new_rating = self(user_id=user_id, product_id=product_id, rating=rating)
    #         session.add(new_rating)
